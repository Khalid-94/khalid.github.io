...
<div class="btn-group" style="width:100%">
  <a href="home.php"><button style="width:25%">Home</button></a>
  <a href="signup.php"><button style="width:25%">Sign Up</button></a>
  <a href="login.php"><button style="width:25%">Login</button></a>
  <a href="products.php"><button style="width:25%">Products</button></a>
</div>
